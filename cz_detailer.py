"""crispz-krea2 - auto face detailer (facon ADetailer / Fooocus "Enhance").
...
Swap) et repasse CHAQUE visage en img2img a haute resolution :
  crop elargi (+60%) -> agrandi au sweet spot du modele (~832 px) -> refine Krea 2
...
_TARGET = 832      # cote de travail du crop (sweet spot Krea 2, /32)
