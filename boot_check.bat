@echo off
REM Boot check generique crispz-krea2 (remplace les anciens scripts rtx5090).
REM
...
echo [4/5] diffusers...
!RUNPY! -c "from diffusers import Krea2Pipeline; print('    Krea 2 pipelines OK')" 2>nul
if errorlevel 1 echo    [ATTENTION] Krea 2 pipelines indisponibles -^> lance install.bat / update.bat.
echo.
...
if defined EXPOSE (
    ...
    echo  crispz-krea2 n'a AUCUNE authentification et sert ton dossier de
...
echo ====================================================
echo    Checks OK. Lancement de crispz-krea2...
echo ====================================================
