"""crispz-krea2 - UI/static assets (pure strings, no logic).
...
<title>crispz-krea2 - Asset Browser</title>
<style>
...
else grid.innerHTML='<p style="padding:20px;color:#8b98ad">No index yet. Click Reindex in crispz-krea2.</p>';});}
