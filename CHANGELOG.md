...
multiples of 16. They cost ~1,6 and ~1,3 Mpix against ~1 Mpix for the rest of the list,
so they are slower — worth it when the recipe you are following calls for them.
