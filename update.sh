#!/usr/bin/env bash
# Update crispz-krea2 (Unix): recupere les commits GitHub puis remet les
...
"$RUNPY" -c "from diffusers import Krea2Pipeline; print('diffusers: Krea 2 pipelines OK')" || {
  echo "[ERREUR] diffusers ne fournit plus les pipelines Krea 2."
